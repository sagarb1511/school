...
const Teacher = () => {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      />
      <Dashboard/>
      <div className="flex-1 bg-gradient-to-br from-blue-50 to-indigo-100 py-8 px-4 sm:px-6 lg:px-8 overflow-auto ml-0 sm:ml-64">
            ...
            <div className="mb-8">
              <div className="flex flex-col sm:flex-row sm:items-start justify-between mb-4 gap-4">
                ...
                <button
                  type="button"
                  onClick={() => setShowManageModal(true)}
                  className="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-medium transition-colors shadow-md hover:shadow-lg flex items-center gap-2 self-start"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
          ...
          <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-6 mt-8">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-6 gap-4">
              <div className="flex-1">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">All Staff Members</h2>
                <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                  <div className="text-sm text-gray-600">
                    Total: <span className="font-semibold">{staffList.length}</span> staff members
                  </div>
                  {getFilteredStaff().length !== staffList.length && (
                    <div className="text-sm text-blue-600">
                      Showing: <span className="font-semibold">{getFilteredStaff().length}</span> filtered results
                    </div>
                  )}
                </div>
              </div>
              <div className="relative">
                <input
                  ...
                  className="w-full lg:w-64 px-4 py-2 pl-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm"
                />
            ...
            {getFilteredStaff().length === 0 && staffList.length > 0 ? (
              <div className="text-center py-12 text-gray-500">
                <svg className="w-16 h-16 mx-auto mb-4 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                </svg>
                <p className="text-lg">No staff members found for "{searchTerm}"</p>
                <button
                  onClick={() => setSearchTerm('')}
