      ...
      <nav className={`bg-gradient-to-r from-[#e0ddd7] via-[#cecbc6] to-[#e0ddd7] shadow-xl transition-all duration-300 ${isScrolled ? 'fixed top-0 left-0 right-0' : 'relative'}`}>
        <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
          <div className="flex justify-between items-center h-14 sm:h-16">
            {/* Enhanced Logo Section */}
            <div className="flex items-center space-x-2 sm:space-x-3 group">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-[#775448] to-[#832936] rounded-xl flex items-center justify-center shadow-lg transform group-hover:scale-110 transition-all duration-300 hover:shadow-xl">
                <span className="text-[#e0ddd7] font-bold text-sm sm:text-base animate-bounce">VSM</span>
              </div>
              <div className="hidden sm:block">
